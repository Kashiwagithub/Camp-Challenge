...
public class UserDataDAO {
    ...
    public ArrayList<UserDataDTO> search(UserDataDTO ud) throws SQLException{
        ...
        try{
            ...
            ArrayList<UserDataDTO> resultdatadto = new ArrayList<UserDataDTO>(); //User
            while(rs.next()){
            ...
            resultdatadto.add(resultUd);
            }
            
            System.out.println("search completed");

            return resultdatadto; //ArrayList search methodを読んでるところを修正(jsp)
        }catch(SQLException e){
            System.out.println(e.getMessage());
            throw new SQLException(e);
        }finally{
